...
contract('Kursor', function(accounts) {
  // it("should put 10000 MetaCoin in the first account", function() {
  //   return Kursor.deployed().then(function(instance) {
  ...
  it("create course", function() {
    ...
    return Kursor.deployed().then(function(instance) {
      ...
      return instance.createCourse.call("c++ for dummers")
    }).then(function(a) {
      console.log(2)
      return kurs.getCourse.call("c++ for dummers")
